    ...
    .action(async (options) => {
        ...
        try {
            ...
            const models: FilerModels = {
                channelManager: (replicant as any).channelManager,
                connections: (replicant as any).connections,
                leuteModel: (replicant as any).leuteModel,
                notifications: (replicant as any).notifications,
                topicModel: (replicant as any).topicModel,
                iomManager: (replicant as any).iomManager,
                journalModel: (replicant as any).journalModel,
                questionnaireModel: (replicant as any).questionnaires,
                consentModel: (replicant as any).consentFile
            };
